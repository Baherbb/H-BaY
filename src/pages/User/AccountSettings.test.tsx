...
describe("AccountSettings Component - Hossam Amir's Tests", () => {
  ...
  test("test updating phone number successfully", () => {
  ...
  test("test displaying error if password fields are empty", () => {
  ...
  test("test displaying error if new password and confirm password do not match", () => {
  ...
  test("test updating password successfully", () => {
    const currentPasswordInput = screen.getByPlaceholderText("Current Password");
    const newPasswordInput = screen.getByPlaceholderText("New Password");
    const confirmPasswordInput = screen.getByPlaceholderText("Confirm Password");
    const updatePasswordButton = screen.getByText("Update Password");
