      ...
      <div className="w-full max-w-5xl bg-white shadow-lg rounded-lg p-8 mt-10">
                ...
                <div key={step.id} className="flex flex-col items-center">
                  ...
                  <p
                    className={`mt-2 text-sm font-semibold ${
                      status === "complete" ? "text-orange-600" : "text-gray-500"
                    }`}
                  >
                    {step.label}
                  </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="bg-white border rounded-lg shadow-lg p-4 hover:shadow-xl transition duration-300">
            ...
            />
            <p className="text-center font-semibold">Dell Laptop with 500GB HDD</p>
          ...
          <div className="bg-white border rounded-lg shadow-lg p-4 hover:shadow-xl transition duration-300">
            <img
              ...
              className="w-24 h-24 mx-auto mb-4"
            />
            <p className="text-center font-semibold">HP Laptop with 500GB HDD</p>
          ...
          <div className="bg-white border rounded-lg shadow-lg p-4 hover:shadow-xl transition duration-300">
            <img
              ...
              className="w-24 h-24 mx-auto mb-4"
            />
            <p className="text-center font-semibold">ACER Laptop with 500GB HDD</p>
